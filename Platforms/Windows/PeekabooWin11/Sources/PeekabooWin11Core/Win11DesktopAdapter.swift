...
public struct UnsupportedWin11DesktopAdapter: Win11DesktopAdapter {
    ...
    public func setUIAutomationElementZoomLevel(
        ...
        maxElements _: Int,
        elementIndex _: Int,
        zoomLevel _: Double) throws -> DesktopUIAutomationActionResult
    {
        throw self.unsupported()
    }
    ...
    public func startUIAutomationSynchronizedInput(
        ...
        maxElements _: Int,
        elementIndex _: Int,
        inputType _: DesktopUIAutomationSynchronizedInputType) throws -> DesktopUIAutomationActionResult
    {
        throw self.unsupported()
    }
    ...
    public func navigateUIAutomationCustom(
        ...
        maxElements _: Int,
        elementIndex _: Int,
        direction _: DesktopUIAutomationNavigationDirection) throws -> DesktopUIAutomationActionResult
    {
        throw self.unsupported()
    }
    ...
    public func getUIAutomationSpreadsheetItemByName(
        ...
        maxElements _: Int,
        elementIndex _: Int,
        name _: String) throws -> DesktopUIAutomationActionResult
    {
        throw self.unsupported()
    }
    ...
    public func findUIAutomationItemByProperty(
        ...
        maxElements _: Int,
        elementIndex _: Int,
        property _: DesktopUIAutomationItemContainerProperty,
        value _: String) throws -> DesktopUIAutomationActionResult
    {
        throw self.unsupported()
    }
    ...
    public func getUIAutomationGridItem(
        ...
        elementIndex _: Int,
        row _: Int,
        column _: Int) throws -> DesktopUIAutomationActionResult
    {
        throw self.unsupported()
    }
