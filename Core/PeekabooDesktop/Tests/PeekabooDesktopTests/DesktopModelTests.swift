...
final class DesktopModelTests: XCTestCase {
    ...
    func testDisabledUIAutomationElementsOmitUnavailableActions() throws {
        ...
        XCTAssertFalse(actions.contains(.setDockPosition))
        XCTAssertFalse(actions.contains(.setCurrentView))
    ...
    func testSyncAdapterAsyncBridgeForwardsCalls() async throws {
        ...
        let getSpreadsheetItem = try await bridge.getUIAutomationSpreadsheetItemByName(
            ...
            elementIndex: 0,
            name: "Revenue")
        let findItem = try await bridge.findUIAutomationItemByProperty(
            scope: .root,
            maxDepth: 1,
            maxElements: 4,
            elementIndex: 0,
    ...
    func testDesktopCommandRunnerRoutesAutomationSnapshot() {
        ...
        XCTAssertTrue(result.stdout.contains("\"findItemByProperty\""))
    ...
    func testDesktopCommandRunnerRejectsDisabledAutomationSetDockPosition() {
        let result = self.runDesktopCommand([
            "peekaboo-desktop",
            "automation",
            "set-dock-position",
    ...
    func testDesktopCommandRunnerRejectsDisabledAutomationSetCurrentView() {
        let result = self.runDesktopCommand([
            "peekaboo-desktop",
            "automation",
            "set-current-view",
    ...
    func testDesktopCommandRunnerRoutesAutomationFindItemByProperty() {
        ...
        XCTAssertEqual(result.status, 0)
        XCTAssertEqual(result.stderr, "")
        XCTAssertTrue(result.stdout.contains("\"action\" : \"findItemByProperty\""))
        XCTAssertTrue(result.stdout.contains("\"elementIndex\" : 0"))
    ...
    func testDesktopCommandRunnerRejectsMissingAutomationFindItemIndex() {
        let result = self.runDesktopCommand([
            "peekaboo-desktop",
            "automation",
            "find-item",
    ...
    func testDesktopCommandRunnerRejectsMissingAutomationFindItemProperty() {
        let result = self.runDesktopCommand([
            "peekaboo-desktop",
            "automation",
            "find-item",
        ...
        XCTAssertEqual(result.status, 1)
        XCTAssertEqual(result.stdout, "")
        XCTAssertTrue(result.stderr.contains("Missing --property <name|automation-id>"))
    }

    func testDesktopCommandRunnerRejectsMissingAutomationFindItemValue() {
        let result = self.runDesktopCommand([
            "peekaboo-desktop",
            "automation",
            "find-item",
        ...
        XCTAssertEqual(result.status, 1)
        XCTAssertEqual(result.stdout, "")
        XCTAssertTrue(result.stderr.contains("Missing --value <property-value>"))
    }

    func testDesktopCommandRunnerRejectsInvalidAutomationFindItemProperty() {
        let result = self.runDesktopCommand([
            "peekaboo-desktop",
            "automation",
            "find-item",
        ...
        XCTAssertEqual(result.status, 1)
        XCTAssertEqual(result.stdout, "")
        XCTAssertTrue(result.stderr.contains("UI Automation item property must be name or automation-id"))
    }
    ...
    func testDesktopCommandRunnerRejectsDisabledAutomationSelect() {
        let result = self.runDesktopCommand([
            "peekaboo-desktop",
            "automation",
            "select",
    ...
    func testDesktopCommandRunnerRejectsDisabledAutomationAddToSelection() {
        let result = self.runDesktopCommand([
            "peekaboo-desktop",
            "automation",
            "add-to-selection",
    ...
    func testDesktopCommandRunnerHelpIncludesWindowCapture() {
        ...
        XCTAssertTrue(result.stdout.contains("automation set-current-view --index"))
        XCTAssertTrue(result.stdout.contains("automation set-zoom --index"))
        XCTAssertTrue(result.stdout.contains("automation zoom-by-unit --index"))
        ...
        XCTAssertTrue(result.stdout.contains("automation find-item --index"))
        ...
        XCTAssertTrue(result.stdout.contains("automation realize --index"))
